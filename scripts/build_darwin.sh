...
export CGO_CFLAGS="$(go env CGO_CFLAGS) -mmacosx-version-min=14.0"
export CGO_CXXFLAGS="$(go env CGO_CXXFLAGS) -mmacosx-version-min=14.0"
export CGO_LDFLAGS="$(go env CGO_LDFLAGS) -mmacosx-version-min=14.0"
